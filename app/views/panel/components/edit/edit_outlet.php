    ...
    <div class="container">
        <form method="post" class="wrapper" id="form-login">
            ...
            <div class="input-group">
                <label for="nama">Nama Outlet</label> <input autofocus type="text" name="nama" id="nama" placeholder="Nama Outlet" autocomplete="off" required value="<?= $currentOutlet['nama'] ?>">
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="tlp" id="tlp" pattern="^\d{8,12}$" autocomplete="off" placeholder="Nomor Telpon" required value="<?= $currentOutlet['tlp'] ?>">
            </div>
